...
class Migrate:
    ...
    def check_url(self, module_ids: Optional[List[str]] = ..., new: bool = ...): ...
    def check_ids(self, module_ids: Optional[List[str]] = ..., new: bool = ...): ...
    def clear_null_values(self, module_ids: Optional[List[str]] = ..., new: bool = ...): ...
